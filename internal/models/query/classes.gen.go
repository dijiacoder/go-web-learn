...
type class struct {
	...
	ALL         field.Asterisk
	ID          field.Int32
	Name        field.String // 班级名称
	Grade       field.String // 年级
	HeadTeacher field.String // 班主任
...
func (c *class) updateTableName(table string) *class {
	...
	c.HeadTeacher = field.NewString(table, "head_teacher")
	c.CreatedAt = field.NewTime(table, "created_at")
	c.UpdatedAt = field.NewTime(table, "updated_at")
	c.IsDel = field.NewInt32(table, "is_del")
...
func (c *class) fillFieldMap() {
	...
	c.fieldMap["head_teacher"] = c.HeadTeacher
